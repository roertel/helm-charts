...
| config | list | `[]` | array to preserve order. |
| rawConfig | string | `nil` | file with. Will be concatenated with 'config' list, above. |
| extraConfig | list | `[]` | file. Uses an array to preserve order. |
| rawExtraConfig | string | `nil` | previously-specified configuration. Uses an array to preserve order. |
| image.repository | string | `"fredbcode/e2guardian"` |  |
...
| securityContext.runAsUser | int | `1161` |  |
| service.type | string | `"ClusterIP"` |  |
| service.port | int | `1344` |  |
